  ...
  return (
    <div className="w-full max-w-2xl p-6 rounded-2xl shadow-2xl text-white">
      ...
      <div className="flex gap-4">
        <button className="w-full py-3 rounded-xl bg-gray-700 hover:bg-gray-600 cursor-pointer active:scale-95 duration-75">
          Continue Shopping
        </button>

        <button className="w-full py-3 rounded-xl bg-green-500 hover:bg-green-600 font-semibold cursor-pointer active:scale-95 duration-75">
          Checkout
        </button>
      </div>
    </div>
